export class Storage {
    ...
    supprimerFavori(name) {
        ...
        // On créer un nouveau tableau grace à filter mais sans le sumo qu'on veut supprimer
    ...
    estFavori(name) {
        ...
        // On parcours le tableau avec .includes et on envoie true si il est dedans,false sinon
